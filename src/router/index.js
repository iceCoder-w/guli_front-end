...
//     name: '周报管理',
//     meta: { title: '周报管理', icon: 'example' },
//     children: [
//       {
//         path: 'list',
//         name: '所有周报列表',
//         component: () => import('@/views/edu/report/list'),
//         meta: { title: '周报列表', icon: 'table' }
//       },
//       {
//         path: 'info',
//         name: '添加周报',
...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      path: 'dashboard',
      component: () => import('@/views/dashboard/index'),
      meta: { title: '周报管理平台', icon: 'dashboard' }
    }]
  }]
/**
 * 动态路由
